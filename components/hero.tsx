  ...
  return (
    <section className="relative py-12 md:py-20 overflow-hidden bg-gray-50/30 dark:bg-gray-900/20">
      ...
      <div className="container relative z-10 px-4 mx-auto">
        ...
        >
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-10 md:mb-12 leading-[1.5] md:leading-[1.4] tracking-normal bg-clip-text text-transparent bg-gradient-to-r from-blue-700 via-blue-600 to-cyan-500 drop-shadow-sm">
            Open Source Robotics<br className="hidden sm:block" />
            Learning Community
          </h1>
          
          <p className="text-lg md:text-xl mb-12 md:mb-14 text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-loose">
